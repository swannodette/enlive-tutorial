...
Let's break it down. Again we have <code>map</code>. We know that it maps a function over a vector to return a new vector of elements with that fuction applied.
