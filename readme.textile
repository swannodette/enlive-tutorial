...
But even this is kinda meh. While Enlive does not have a great shortcut for expressing this pattern it's easy to write macros. I've included a handy macro called <code>maybe-content</code> which allows to write something like this:

<pre>
(html/deftemplate index "tutorial/template1.html"
  [ctxt]
  [:p#message] (maybe-content (:message ctxt) "Nothing to set here!"))
</pre>
