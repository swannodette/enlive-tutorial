...
<pre>
.links:nth-of-type(1) > *:first-child
</pre>
...
Thus while we've seen some interesting features and HTML/code seperation is cool, Enlive seems like it involves <i>more</i> work then it actually saves. That's because we're showing very trival example. In the third example we'll show just how much time Enlive can save you laying things out how a real site might be organized.
