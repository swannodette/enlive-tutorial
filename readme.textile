...
Because this scrape is not comprehensive we might match empty stories, so define a function <code>empty-story?</code> that checks for that. Hopefully by this point you can begin to make sense of the last three functions.
