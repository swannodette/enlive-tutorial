...
This is the Compojure route defining syntax. It shouldrelatively familiar to the working web developer especially if you have any experience with a modern web framework. A couple things to note <code>render</code> is not a function of Enlive, it's something I added via *utils.clj* in the repository. <code>render</code> isn't magic it's just a function that looks like this:
